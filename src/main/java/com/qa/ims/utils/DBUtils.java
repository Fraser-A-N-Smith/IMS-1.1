...
public class DBUtils {
	...
	private DBUtils(String properties) {
		...
		this.dbUrl = dbProps.getProperty("db.url", "jdbc:mysql://localhost:3306/?useUnicode=true&useJDBCCompliantTimezoneShift=true&useLegacyDatetimeCode=false&serverTimezone=UTC");
		this.dbUser = dbProps.getProperty("db.user", "root");
		this.dbPassword = dbProps.getProperty("db.password", "S0uthampt0n44");
	}
